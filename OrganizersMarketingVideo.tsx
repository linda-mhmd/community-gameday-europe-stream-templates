  ...
  return (
    <AbsoluteFill style={{ opacity: exitOpacity }}>
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 }}>
        <Img src={staticFile("AWSCommunityGameDayEurope/GameDay_Solid_Logo_for_swag/GameDay Logo Solid White.png")} style={{ width: 320, objectFit: "contain", opacity: logoSpring, transform: `scale(${logoScale})` }} />
        <Img src={staticFile("AWSCommunityGameDayEurope/AWSCommunityEurope_last_nobackground.png")} style={{ width: 220, objectFit: "contain", opacity: logo2Spring, transform: `scale(${logo2Scale})` }} />
      </AbsoluteFill>
    </AbsoluteFill>
  );
};
    ...
    <AbsoluteFill>
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20 }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, opacity: logoSpring, transform: `scale(${logoScale})` }}>
          <Img src={staticFile("AWSCommunityGameDayEurope/GameDay_Solid_Logo_for_swag/GameDay Logo Solid White.png")} style={{ width: 280, objectFit: "contain" }} />
          <Img src={staticFile("AWSCommunityGameDayEurope/AWSCommunityEurope_last_nobackground.png")} style={{ width: 180, objectFit: "contain" }} />
        </div>
